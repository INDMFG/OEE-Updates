...
def update_main_screen_ui(current_shift):
    ...
    if current_shift is None:
        ...
        set_cached_label_text("avg_load_time", ui_AVRG_LOAD_TIME_NUMBER, format_mmss(get_pending_shift_average_load(current_shift)))
        set_cached_label_text("avg_idle_time", ui_AVRG_IDLE_TIME_NUMBER, format_mmss(get_pending_shift_average_idle(current_shift)))
