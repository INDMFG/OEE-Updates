...
def ensure_software_update_popup():
    ...
    global software_update_refresh, software_update_ok, software_update_close
    ...
    software_update_refresh = make_button(software_update_popup, "REFRESH", -180, 150, 120, 40, 0x04BE2D)
    software_update_ok = make_button(software_update_popup, "OK", 0, 150, 120, 40, 0x0A0ACC)
    software_update_close = make_button(software_update_popup, "CLOSE", 180, 150, 120, 40, 0xC32331)
