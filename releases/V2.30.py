...
def build_machine_status_payload(existing=None):
    ...
    for shift_name in SHIFT_NAMES:
        ...
        completed_avg_seconds = int(round(get_completed_shift_average_with_load(shift_name)))
        shifts_payload[shift_name] = {
            "graph_pph": int(get_graph_shift_pph(shift_name)),
            "live": {
                ...
                "avg_with_load_seconds": live_avg_seconds,
            ...
            "completed": {
                ...
                "pph": int(get_completed_shift_pph(shift_name)),
                "avg_with_load_seconds": completed_avg_seconds,
                "avg_with_load": format_mmss(completed_avg_seconds),
            },
        }
    ...
    return {
        ...
        "pph_rules": {
            "ignore_first_cycles": PPH_IGNORE_INITIAL_CYCLES,
            "show_after_counted_cycles": PPH_DISPLAY_READY_CYCLES,
            "stop_before_shift_end_minutes": PPH_STOP_BEFORE_SHIFT_END_MINUTES,
        },
...
def upload_stats_to_github(manual=False):
    ...
    commit_body = {
        ...
        "content": base64_encode_bytes(json.dumps(payload, indent=2).encode("utf-8")),
...
def stats_config_import_event(e):
    ...
    try:
        ...
        stats_config_status.set_text("Import failed")
        settings_menu_status.set_text("Token import failed")
